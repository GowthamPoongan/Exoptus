...
export default function HomeScreen() {
  ...
  const calendarVisible = useDashboardStore((s) => s.isCalendarOpen);
  const setCalendarVisible = useDashboardStore((s) => s.setCalendarOpen);
            ...
            <View style={styles.headerInner}>
              ...
              <View style={styles.headerRight}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <CalendarIconSmall color="#18181B" size={20} />
                </TouchableOpacity>
